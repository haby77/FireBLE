...
const struct atts_desc ans_att_db[ANS_IDX_NB] =
{
...
struct anps_idx_env_tag **anps_idx_envs;
...
void anps_init(void)
{
    ...
    // Register ANPS task into kernel
    task_anps_desc_register();

    // Reset all environments
    prf_client_reset((prf_env_struct ***)&anps_idx_envs, TASK_ANPS, ANPS_DISABLED);
...
void anps_disable(struct anps_idx_env_tag *anps_idx_env)
{
    // Disable ANS
    ...
    ind->conhdl                      = anps_idx_env->con_info.conhdl;
