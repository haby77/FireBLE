...
#include "LPC17xx.h"
#include "lpc_types.h"
extern volatile uint8_t rd_ongoing;
extern volatile uint8_t wr_ongoing;
extern uint8_t tx_buffer[80];
#ifdef __cplusplus
extern "C"
{
#endif
...
typedef struct {
    ...
    uint32_t rd_length;//intended to read data length
    uint32_t wr_length;//intended to write data length
