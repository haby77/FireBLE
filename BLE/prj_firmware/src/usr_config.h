...
/// Brun-in Test mode controll pin
//#define CFG_BRUN_IN_TEST_CTRL_PIN GPIO_P27
...
/// Memory retention
#define CFG_MEM_RETENTION   (MEM_BLOCK0 | MEM_BLOCK1 | MEM_BLOCK2 | MEM_BLOCK3 | MEM_BLOCK4 | MEM_BLOCK5 | MEM_BLOCK6 | MEM_BLOCK7)
